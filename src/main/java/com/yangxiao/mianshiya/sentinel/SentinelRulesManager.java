package com.yangxiao.mianshiya.sentinel;
...
public class SentinelRulesManager {
    ...
    public void initFlowRules() {
        // 单 IP 查看题目列表限流规则
        ParamFlowRule rule = new ParamFlowRule(QUESTION_LIST_PAGE_SENTINEL)
    ...
    public void initDegradeRules() {
        // 单 IP 查看题目列表熔断规则
        DegradeRule slowCallRule = new DegradeRule(QUESTION_LIST_PAGE_SENTINEL)
                .setGrade(CircuitBreakerStrategy.SLOW_REQUEST_RATIO.getType())
                .setCount(0.2) // 慢调用比例大于 20%
                .setTimeWindow(60) // 熔断持续时间 60 秒
                .setStatIntervalMs(30 * 1000) // 统计时长 30 秒
                .setMinRequestAmount(10) // 最小请求数
                .setSlowRatioThreshold(3000); // 响应时间超过 3 秒

        DegradeRule errorRateRule = new DegradeRule(QUESTION_LIST_PAGE_SENTINEL)
